...
import { Loader2, User, FileText, IndianRupee, Calendar as CalendarIcon, CreditCard, Hash, Search, ChevronDown, Check } from 'lucide-react';
  ...
  useEffect(() => {
    const subscription = form.watch((values, { name }) => {
        ...
        if (name === 'totalFee' || name === 'discount' || name === 'amountPaid') {
            const finalPayable = totalFee - discount;
