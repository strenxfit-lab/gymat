...
export default function SuperAdminCommunityProfilePage() {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      ...
      if (!storedUsername || !userId) {
        ...
        router.push('/dashboard/superadmin/community');
        return;
      }
              ...
              <div className="flex-1">
                  <div className="flex items-center gap-4 mb-2 flex-wrap">
                      ...
                      <div className="flex items-center gap-2">
                        <Link href="/dashboard/superadmin/profile/edit" passHref>
                            <Button variant="outline" size="sm"><Edit className="mr-2 h-4 w-4"/>Edit Profile</Button>
                        </Link>
                         <Link href="/dashboard/superadmin/profile/settings" passHref>
