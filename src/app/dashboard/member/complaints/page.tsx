...
export default function MemberComplaintsPage() {
  ...
  const fetchComplaints = async () => {
    ...
    try {
        ...
        const q = query(complaintsCollection, where('authorId', '==', memberId), orderBy('submittedAt', 'desc'));
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const activeBranchId = localStorage.getItem('activeBranch');
    const memberId = localStorage.getItem('memberId');
    const memberName = localStorage.getItem('userName'); // Assuming name is stored
    ...
    try {
        ...
        await addDoc(complaintsCollection, {
            ...
            authorId: memberId,
            authorName: memberName || "Unknown Member",
            authorRole: 'member',
            status: 'Pending',
