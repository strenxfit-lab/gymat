        ...
        <Card key={posts[i].id} className="mb-4">
                  ...
                  <div className="flex justify-between items-start">
                      ...
                      <DropdownMenu>
                          ...
                          <DropdownMenuContent>
                              ...
                              <DropdownMenuItem onSelect={() => handleReportPost(posts[i].id, posts[i].authorId)}>
          ...
          <CardContent>
              ...
              {posts[i].repost ? (
                  ...
                  posts[i].mediaUrls && posts[i].mediaUrls.length > 0 && (
                      <div className={cn("grid gap-2", posts[i].mediaUrls.length > 1 ? "grid-cols-2" : "grid-cols-1")}>
          ...
          <CardFooter className="flex flex-col items-start gap-4">
               <div className="flex flex-wrap gap-4">
                  <Button variant="ghost" size="sm" onClick={() => handleLike(posts[i])}>
               ...
               {openComments[posts[i].id] && (
                   <div className="w-full pl-4 border-l-2">
                      <Form {...commentForm}>
                          <form onSubmit={commentForm.handleSubmit((data) => handleCommentSubmit(posts[i], data))} className="flex gap-2 mb-4">
